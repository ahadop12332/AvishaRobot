...
async def active_afk(_, message: Message):
        ...
        try:
            ...
            if afktype == "text":
                send = await message.reply_text(
                    f"**𖣐 {message.from_user.first_name}** ɪs ʙᴀᴄᴋ ᴏɴʟɪɴᴇ ᴀɴᴅ ᴡᴀs ᴀᴡᴀʏ ғᴏʀ {seenago}",
            ...
            if afktype == "animation":
                if str(reasonafk) == "None":
                    send = await message.reply_animation(
                        data,
                        caption=f"**𖣐 {message.from_user.first_name}** ɪs ʙᴀᴄᴋ ᴏɴʟɪɴᴇ ᴀɴᴅ ᴡᴀs ᴀᴡᴀʏ ғᴏʀ {seenago}",
                    )
                else:
                    send = await message.reply_animation(
                        data,
            ...
            send = await message.reply_text(
                f"**𖣐 {message.from_user.first_name}** ɪs ʙᴀᴄᴋ ᴏɴʟɪɴᴇ",
                disable_web_page_preview=True,
            )
    ...
    await message.reply_photo(
        ...
        caption=f"𖣐 {message.from_user.first_name} ɪs ɴᴏᴡ ᴀғᴋ !" , reply_markup=InlineKeyboardMarkup(EVAA),
    )
...
async def chat_watcher_func(_, message):
    ...
    if verifier:
        ...
        try:
            ...
            seenago = get_readable_time((int(time.time() - timeafk)))
            if afktype == "text":
                msg += f"**𖣐 {user_name[:25]}** ɪs ʙᴀᴄᴋ ᴏɴʟɪɴᴇ ᴀɴᴅ ᴡᴀs ᴀᴡᴀʏ ғᴏʀ {seenago}\n\n"
            if afktype == "text_reason":
                msg += f"**𖣐 {user_name[:25]}** ɪs ʙᴀᴄᴋ ᴏɴʟɪɴᴇ ᴀɴᴅ ᴡᴀs ᴀᴡᴀʏ ғᴏʀ {seenago}\n\n● ʀᴇᴀsᴏɴ ➥ `{reasonafk}`\n\n"
            if afktype == "animation":
                if str(reasonafk) == "None":
                    send = await message.reply_animation(
                        data,
                        caption=f"**𖣐 {user_name[:25]}** ɪs ʙᴀᴄᴋ ᴏɴʟɪɴᴇ ᴀɴᴅ ᴡᴀs ᴀᴡᴀʏ ғᴏʀ {seenago}\n\n", reply_markup=InlineKeyboardMarkup(EVAA),
                    )
                else:
                    send = await message.reply_animation(
                        data,
            ...
            msg += f"**𖣐 {user_name[:25]}** ɪs ʙᴀᴄᴋ ᴏɴʟɪɴᴇ\n\n"
        ...
        try:
            ...
            if verifier:
                try:
                    ...
                    if afktype == "text":
                        msg += (
                            f"**𖣐 {replied_first_name[:25]}** ɪs ᴀғᴋ sɪɴᴄᴇ {seenago}\n\n"
                        )
                    if afktype == "text_reason":
                        msg += f"**𖣐 {replied_first_name[:25]}** ɪs ᴀғᴋ sɪɴᴄᴇ {seenago}\n\n● ʀᴇᴀsᴏɴ ➥ `{reasonafk}`\n\n"
                    if afktype == "animation":
                        if str(reasonafk) == "None":
                            send = await message.reply_animation(
                                data,
                                caption=f"**𖣐 {replied_first_name[:25]}** ɪs ᴀғᴋ sɪɴᴄᴇ {seenago}\n\n", reply_markup=InlineKeyboardMarkup(EVAA),
                            )
                        else:
                            send = await message.reply_animation(
                                data,
                    ...
                    msg += f"**𖣐 {replied_first_name}** ɪs ᴀғk"
        except:
            pass
            ...
            if (entity[j].type) == MessageEntityType.MENTION:
                ...
                if verifier:
                    try:
                        ...
                        if afktype == "text":
                            msg += (
                                f"**𖣐 {user.first_name[:25]}** ɪs ᴀғᴋ sɪɴᴄᴇ {seenago}\n\n"
                            )
                        if afktype == "text_reason":
                            msg += f"**𖣐 {user.first_name[:25]}** ɪs ᴀғᴋ sɪɴᴄᴇ {seenago}\n\n● ʀᴇᴀsᴏɴ ➥ `{reasonafk}`\n\n"
                        if afktype == "animation":
                            if str(reasonafk) == "None":
                                send = await message.reply_animation(
                                    data,
                                    caption=f"**𖣐 {user.first_name[:25]}** ɪs ᴀғᴋ sɪɴᴄᴇ {seenago}\n\n", reply_markup=InlineKeyboardMarkup(EVAA),
                                )
                            else:
                                send = await message.reply_animation(
                                    data,
                        ...
                        msg += f"**𖣐 {user.first_name[:25]}** ɪs ᴀғᴋ\n\n"
                ...
                if verifier:
                    try:
                        ...
                        seenago = get_readable_time((int(time.time() - timeafk)))
                        if afktype == "text":
                            msg += f"**𖣐 {first_name[:25]}** is ᴀғᴋ sɪɴᴄᴇ {seenago}\n\n"
                        if afktype == "text_reason":
                            msg += f"**𖣐 {first_name[:25]}** ɪs ᴀғᴋ sɪɴᴄᴇ {seenago}\n\n● ʀᴇᴀsᴏɴ ➥ `{reasonafk}`\n\n"
                        if afktype == "animation":
                            if str(reasonafk) == "None":
                                send = await message.reply_animation(
                                    data,
                                    caption=f"**𖣐 {first_name[:25]}** ɪs ᴀғᴋ sɪɴᴄᴇ {seenago}\n\n", reply_markup=InlineKeyboardMarkup(EVAA),
                                )
                            else:
                                send = await message.reply_animation(
                                    data,
                                    caption=f"**𖣐 {first_name[:25]}** ɪs AFK sɪɴᴄᴇ {seenago}\n\n● ʀᴇᴀsᴏɴ ➥ `{reasonafk}`\n\n", reply_markup=InlineKeyboardMarkup(EVAA),
                                )
                        if afktype == "photo":
                            if str(reasonafk) == "None":
                                send = await message.reply_photo(
